...
//-----------------------------------------------------------------------------
	...
	struct a3_DemoState
	{
		...
		int teaPot_rot;		//	- teapot rotation
		int earth_rot;		//	- earth rotation
		float earth_tilt;	//	- earth tilt
		int earth_orbit;	//	- earth orbit
		int earth_distance;	//	- earth orbit distance
